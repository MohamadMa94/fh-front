...
<div  className={` flex items-center rounded-md  `}>
    ...
    <FaVoteYea  className= {` text-4xl  rounded text-indigo-950 font-bold   cursor-pointer block float-left mr-6 duration-500 ${!open && " ml-2 rotate-[360deg]"}`}  />
           <h1 className={` font-bold mx-20 text-indigo-1000  rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white text-3xl ${!open && "scale-0"}`}  aria-current="page"> Voting </h1> </Link>
    </li>
