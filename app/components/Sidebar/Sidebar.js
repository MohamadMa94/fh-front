...
<div className={`bg-gradient-to-tr from-white to-white i justify-aroundh-auto border-4 shadow-2xl border-indigo-1000 pb-10 p-8  m-2 pt-16 rounded-3xl h-screen ${open ? "w-96 px-16" : "w-28"}  relative`}>
